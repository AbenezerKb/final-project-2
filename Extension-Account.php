...
include("segments/ext-account-head.php");
...
<div class="production-btn">
<a href="farmers.php">Farmers</a>
</div>
<div class="guidance-btn">
<a href="annnouncement.php">Announcement</a>
</div>
...
<form>
    ...
    <label class="ftc-label">FTC ID</label>
    <input type="text" class="ftc-input">
